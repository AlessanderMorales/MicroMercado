...
namespace PruebasMicroMercado.BlackBoxTests
{
    ...
    public class SalesPageTests
    {
        ...
        public void CompleteSale_WithCashPayment_ShouldSuccess()
        {
            ...
            decimal vuelto = decimal.Parse(vueltoText);
            Assert.Equal(50, vuelto);
            ...
            try
            {
                ...
                Assert.Contains("éxito", alertText.ToLower(), StringComparison.OrdinalIgnoreCase);
            }
